 ...
 * @author Henrik Paul
 */
public class _Jar implements _Action, _FileProducer {
  
  protected _Compilation fromCompilation;
  ...
  protected void setDefaults() {
    if (fromCompilation == null && fromPath == null) {
      fromCompilation = new _Compilation();
    }
  ...
  private static File getClassesDirectoryFromCompilation(
      final _Compilation compilation) {
    try {
   ...
   */
  public _Jar from(final _Compilation compilation) {
   ...
   *           if any <tt>from()</tt> method was previously called
   */
  public _Jar from(final String path) {
    if (fromPath == null && fromCompilation == null) {
      fromPath = path;
      return this;
    } else {
   ...
   */
  @Override
  public _Jar to(final String path) {
    toPath = path;
    return this;
  }
   ...
   * @return <code>this</code>
   */
  public _Jar withManifestFrom(final String path) {
    manifestPath = path;
    return this;
  }
   ...
   */
  public _Jar withSourcesFrom(final String path) {
    if (!sourcesFromChain) {
